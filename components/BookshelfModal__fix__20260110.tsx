        ...
        if (replies && replies.length > 0) {
          ...
          const formatted = replies.map((r: any, i: number) => {
            ...
            return {
              ...
              originalSenderId: parent?.user_id || '',
              replySender: rSender?.nickname || '誰か', 
              replySenderId: r.user_id, 
              color: colors[i % colors.length],
              parentTitle: parent?.title || '無題'
            };
          });
                    ...
                    >
                      <div className="flex-1 flex justify-between items-center">
                        ...
                        <div className="flex flex-col items-end">
                          ...
                          <span className="text-[10px] font-serif text-[#5d4037]/70 italic">{m.originalSender} ↔ {m.replySender}</span>
                        </div>
                      </div>
                    </div>
                  );
